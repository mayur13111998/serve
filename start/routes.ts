...
Route.group(() => {
  ...
  Route.group(() => {
    ...
    Route.get('/:product_id/all/product_images', 'MappingProductImagesController.index')
    Route.get('/:product_id/product_images', 'MappingProductImagesController.show')
  }).prefix('product')

  Route.group(() => {
    Route.post('/', 'ProductImagesController.store')
  }).prefix('product_image')

  
  Route.group(() => {
    Route.post('/', 'MappingProductImagesController.store')
  }).prefix('product_image_mapping')
